...
* 
*  Name: khushi ID: 166961219 Date: 17 February 2023

github link : https://github.com/khushimidha/Web322-App.git


* cyclic link - https://app.cyclic.sh/#/app/khushimidha-web322-app/overview
website : https://dark-pear-grasshopper-wear.cyclic.app/about
********************************************************************************/
...
app.get("/posts", (req, res) => {
  ...
  if (category) {
   ...
   blogService.getPostsByMinDate(minDateStr).then((data) => {
    ...
    posts = blogService.getAllPosts().then((data) => {
      res.json(data);
    }).catch(error => {
    res.json(error);
  });
